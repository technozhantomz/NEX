...
export const SpreadRow = ({ lastTradeType, lastTradePrice, lastTradeFiatValue, spread } : SpreadProps): JSX.Element => {
    return (
        <Styled.SpreadRow>
            <Styled.SpreadCell>
            ...
            <Styled.SpreadCell>
                {lastTradePrice.toFixed(3)}
            </Styled.SpreadCell>
            <Styled.SpreadCell>
                {lastTradeFiatValue.toFixed(3)}
            </Styled.SpreadCell>
        </Styled.SpreadRow>
    )
}