  ...
  pages: {
    ...
    voting: {
      ...
      gpos: {
        ...
        rewards_way_first:
          "1. Переведите больше %(defaultToken) на свой баланс GPOS.",
        ...
        powerUp: {
          power_up_description:
            "Когда вы активируете свои %(defaultToken) в блокчейне Peerplays, вы делаете свои первые шаги к участию в Децентрализованном автономном кооперативе (DAC), который является волшебством в технологии блокчейна. Это означает, что вы будете:",
          power_up_lists: {
            first:
        ...
        powerDown: {
          power_down_description:
            "Когда вы отключите питание, вам потребуется 30 дней, чтобы полностью снять баланс %(defaultToken)s. Вы будете продолжать получать вознаграждения за участие в течение этого времени, пока вы участвуете. После отключения питания вы можете использовать свои %(defaultToken) как любую другую криптовалюту. Это означает, что вы будете:",
          power_down_lists: {
            first:
